...
\newcommand{\myTime}{Marzec 2023\xspace}
...
\DeclareUnicodeCharacter{0301}{Q}
...
\newglossaryentry{hts}{type=\acronymtype, name={HTS},
	...
	firstplural ={High-Throughput Screenings (HTSs)\glsadd{htsg}} }
...
description={Metal-involved \glsdesc{ppi} is a protein-protein interaction
		in which a vital role is played by a metal},}

\newglossaryentry{mppi}{type=\acronymtype, name={MPPI},
description={Metal-involved \glsdesc{ppi}, \glsseeformat[Glossary:]{mppig}{}},
first={Metal-involved \glsdesc{ppi} (MPPI)\glsadd{mppig}},
plural={MPPIs},
descriptionplural={Metal-involved \glsdescplural{ppi}},
firstplural={Metal-involved \glsdescplural{ppi} (\glsentryplural{mppi})}}
...
description={The Universal Protein Resource (UniProt) is a database of
...
first={American Standard Code for Information Interchange (ASCII)}
}
...
\newglossaryentry{python}{name={\texttt{Python}},
...
name={\texttt{SQL}},
description={\texttt{Structured Query Language}},
first={\texttt{{Structured Query Language}} (\texttt{SQL})},
}

\newglossaryentry{django}{name={\texttt{Django}},
	description={Django is a high-level Python-based web framework.},}
...
\newglossaryentry{asunit}{name={asymmetric unit},
...
\newglossaryentry{rad}{type=\acronymtype,
	name={Rad50},
	description={DNA repair protein Rad50, \glsseeformat[Glossary:]{radg}{}},
	first={DNA repair protein Rad50 (Rad50)\glsadd{radg}},
}
...
name={MRN(X)},
description={\glslink{mre}{Mre11}-\glslink{rad}{Rad50}-\glslink{nbs}{Nbs1}(\glslink{xrs}{Xrs2}) \glsseeformat[Glossary:]{mrng}{}},
first={\glslink{mre}{Mre11}-\glslink{rad}{Rad50}-\glslink{nbs}{Nbs1}(\glslink{xrs}{Xrs2}) complex (MRN(X))\glsadd{mrng}},
}

\newglossaryentry{mr}{type=\acronymtype,
name={MR},
description={\glslink{mre}{Mre11}-\glslink{rad}{Rad50} core complex \glsseeformat[Glossary:]{mrg}{}},
first={\glslink{mre}{Mre11}-\glslink{rad}{Rad50} core complex (MR)\glsadd{mrg}},
}

\newglossaryentry{mrg}{name={MR},
description={The \gls{mr} core complex acts like \gls{mrn} in Bacteria and Archea, despite the lacking
\gls{nbs} or \gls{xrs}.}}
...
name={MALS},
description={multiangle light scattering},
first={multiangle light scattering (MALS)}}
...
first={enthalpy change at standard state (\textDelta \textit{H}\textdegree)}
}
...
first={association constant (\textit{K}\textsubscript{a})}
}
...
first={dissociation constant (\textit{K}\textsubscript{d})}
}


\newglossaryentry{Kex}{type=\acronymtype,
name={\textit{K}\textsubscript{ex}},
description={constant of exchange},
first={constant of exchange (\textit{K}\textsubscript{ex})}
}

\newglossaryentry{koff}{type=\acronymtype,
name={\textit{k}\textsubscript{off}},
description={dissociation rate},
first={dissociation rate (\textit{k}\textsubscript{off})}
}

\newglossaryentry{kon}{type=\acronymtype,
name={\textit{k}\textsubscript{on}},
description={association rate},
first={association rate (\textit{k}\textsubscript{on})}
}
...
name={LMCT},
description={ligand-metal charge transfer},
first={ligand-metal charge transfer (LMCT)}
}

\newglossaryentry{ct}{type=\acronymtype,
name={CT},
description={charge transfer},
first={charge transfer (CT)}
}
...
description={low molecular weight},
first={low molecular weight (LMW)},
}
...
description={single-stranded \glslink{dna}{DNA}},
first={single-stranded \glslink{dna}{DNA} (ssDNA)},
}

\newglossaryentry{dsdna}{type=\acronymtype, name={dsDNA},
description={double-stranded \glslink{dna}{DNA}},
first={double-stranded \glslink{dna}{DNA} (ssDNA)},
}

\newglossaryentry{ku}{type=\acronymtype, name={Ku},
description={non-homologous end joining protein Ku},
first={non-homologous end joining protein Ku (Ku)},
}



\newglossaryentry{ctip}{type=\acronymtype, name={CtiP},
description={CtBP-interacting protein},
first={CtBP-interacting protein (CtiP)},
}

\newglossaryentry{sae}{type=\acronymtype, name={Sae2},
description={DNA endonuclease Sae2},
first={DNA endonuclease Sae2 (Sae2)},
}
...
first={zinc finger (ZF)},
descriptionplural = {zinc fingers},
firstplural = {zinc fingers	(ZFs)}
}
...
name={OSETA},
description={one single-epitope tag affinity purification},
first={one single-epitope tag affinity purification (OSETA)}
}

\newglossaryentry{TAP}{type=\acronymtype,
name={TAP},
description={tandem affinity purification},
first={tandem affinity purification (TAP)}
}
...
name={FRET},
description={Förster resonance energy transfer},
first={Förster resonance energy transfer (FRET)}
}

\newglossaryentry{BLI}{type=\acronymtype,
name={BLI},
description={Bio-Layer Interferometry},
first={Bio-Layer Interferometry (BLI)}
}
...
first={Surface plasmon resonance (SPR)}
}

\newglossaryentry{lck}{type=\acronymtype,
name={Lck},
description={lymphocyte-specific protein tyrosine kinase},
first={lymphocyte-specific protein tyrosine kinase (Lck)}
}

\newglossaryentry{cd4}{type=\acronymtype,
name={CD4},
description={cluster of differentiation 4},
first={cluster of differentiation 4 (CD4)}
}


\newglossaryentry{cd8}{type=\acronymtype,
name={CD8},
description={cluster of differentiation 8},
first={cluster of differentiation 8 (CD8)}
}
...
first={cryogenic electron microscopy (cryoEM)}}


\newglossaryentry{exafs}{type=\acronymtype,
name={EXAFS},
description={extended X-ray absorption fine structure},
first={extended X-ray absorption fine structure (EXAFS)}}

\newglossaryentry{xanes}{type=\acronymtype,
name={XANES},
description={X-ray absorption near-edge structure},
first={X-ray absorption near-edge structure (XANES)}}

\newglossaryentry{fsd1}{type=\acronymtype,
name={FSD-1},
description={full sequence design},
first={full sequence design (FSD-1)}}

\newglossaryentry{zif268}{type=\acronymtype,
name={Zif268},
description={Zinc finger-containing transcription factor 268},
first={Zinc finger-containing transcription factor 268 (Zif268)}}

\newglossaryentry{mukb}{type=\acronymtype,
name={MukB},
description={chromosome partition protein MukB},
first={chromosome partition protein MukB (MukB)}}

\newglossaryentry{zap1}{type=\acronymtype,
name={ZAP1},
description={Zinc-responsive transcriptional regulator ZAP1},
first={Zinc-responsive transcriptional regulator ZAP1 (ZAP1)}}


\newglossaryentry{zrt1}{type=\acronymtype,
name={ZRT1},
description={Zinc-regulated transporter 1},
first={Zinc-regulated transporter 1 (ZRT1)}}

\newglossaryentry{zrt2}{type=\acronymtype,
name={ZRT2},
description={Zinc-regulated transporter 2},
first={Zinc-regulated transporter 2 (ZRT2)}}

\newglossaryentry{zrt3}{type=\acronymtype,
name={ZRT3},
description={Zinc-regulated transporter 3},
first={Zinc-regulated transporter 3 (ZRT3)}}

\newglossaryentry{zip}{type=\acronymtype,
name={ZIP},
description={Zrt-, Irt-like proteins},
first={Zrt-, Irt-like proteins (ZIP)}}
...
\newglossaryentry{nhej}{type=\acronymtype, name={NHEJ},
	description={non-homologous end joining, \glsseeformat[Glossary:]{nhejg}{}},
	first={non-homologous end joining (NHEJ) \glsadd{nhejg}},
	plural={NHEJs},
	descriptionplural={non-homologous end joining},
	firstplural={non-homologous end joining (\glsentryplural{nhej})}}
...
\newglossaryentry{hr}{type=\acronymtype, name={HR},
	description={homologous recombination, \glsseeformat[Glossary:]{hrg}{}},
	first={homologous recombination (HR) \glsadd{hrg}},
	plural={HRs},
	descriptionplural={homologous recombination},
	firstplural={homologous recombination (\glsentryplural{hr})}}
